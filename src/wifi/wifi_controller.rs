// TODO: INVESTIGATE ISSUES WITH WIFI CONTROLLER/DRIVER:
// 1. THE DRIVER STOP ACCEPTING CLIENTS IN AP MODE IN CASE AUTOCONNECT WITH PREVIOUS (OUTDATED) PASSWORD.
// 2. THE DRIVER STOP ACCEPTING CLIENTS IN AP MODE AFTER TRANSITION FROM JOIN MOD WHERE WAS FAILED JOIN ATTEMPT.
